...
import { currenciesObj, itemsObj, categoriesObj } from "./data/all-products";
...
import SignUp from "./routes/SignUp.js"; // Make sure to provide the correct path to your SignUp component
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/signup"
          element={<SignUp />} // Assuming SignUp is the component for the signup page
        />
        <Route
